...
const fallbackEvents = [
    {
        ...
        active: "yes", // Added active status for testing
    },
    {
        _id: "2",
        title: "New Arrivals",
        ...
        endDate: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), // Expired event for testing
        active: "no", // Inactive event
    },
];
    ...
    return (
        <div className="hero-container">
            <div className="event-slide">
                <img src={currentEvent.imageUrl} alt={currentEvent.title} className="event-image" />
            ...
            {events.length > 1 && (
                <>
                    ...
                    <div className="dots">
                        {events.map((_, index) => (
                            <button key={index} className={`dot ${index === currentSlide ? "active" : ""}`} onClick={() => goToSlide(index)} />
                        ))}
                    </div>
                </>
            )}
